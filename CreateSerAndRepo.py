...
writeData.write("\n")
writeData.write("\tpublic "+modelName+" getPk1(Integer pk0) throws Exception {\n")
writeData.write("\t\ttry {\n")
writeData.write("\t\t\treturn rep.findById(pk0);\n")
writeData.write("\t\t} catch (Exception e) {\n")
writeData.write("\t\t\tthrow new Exception(e.getMessage());\n")
writeData.write("\t\t}\n")
writeData.write("\t}\n")
writeData.write("\n")
writeData.write("\tpublic "+modelName+" getPk2(String pk0) throws Exception {\n")
writeData.write("\t\ttry {\n")
writeData.write("\t\t\treturn rep.findByName(pk0);\n")
writeData.write("\t\t} catch (Exception e) {\n")
writeData.write("\t\t\tthrow new Exception(e.getMessage());\n")
writeData.write("\t\t}\n")
writeData.write("\t}\n")
writeData.write("\n")
writeData.write("\tpublic Integer setData("+modelName+" val) throws Exception {\n")
writeData.write("\t\ttry {\n")
writeData.write("\t\t\treturn rep.save(val).getId();\n")
writeData.write("\t\t} catch (Exception e) {\n")
writeData.write("\t\t\tthrow new Exception(e.getMessage());\n")
writeData.write("\t\t}\n")
writeData.write("\t}\n")
...
writeData.write("\t"+modelName+" findById(Integer pk0);\n")
writeData.write("\t"+modelName+" findByName(String pk0);\n")
